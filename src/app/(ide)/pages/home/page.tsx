...
export default function HomePage() {
  return (
    <main className={styles.page} data-testid="home-page">
      {/* 로고 — 우상단 */}
      <div className={styles.logo} data-testid="home-logo">
        <Icon
      ...
      {/* 스텝 행 */}
      <div className={styles.stepRow} data-testid="home-step">
        <span className={styles.stepNumber}>01</span>
        <span className={styles.stepTitle}>Figma mcp로 디자인 시스템 구성하기</span>
      </div>

      {/* 메인 헤딩 */}
      <h1 className={styles.heading} data-testid="home-heading">
        이제 디자인 시스템부터<br />
        차곡 차곡 쌓아나가볼까요?
      </h1>

      {/* 배경 이미지 */}
      <div className={styles.bgImage} data-testid="home-bg-image">
        <Image
