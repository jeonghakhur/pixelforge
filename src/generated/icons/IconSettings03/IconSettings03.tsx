...
interface IconSettings03Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconSettings03 = ({ size, color, className, ...props }: IconSettings03Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-settings03", size && "size-" + size, className].filter(Boolean).join(" ")}
