...
interface IconFaceSmileProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconFaceSmile = ({ size, color, className, ...props }: IconFaceSmileProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-face-smile", size && "size-" + size, className].filter(Boolean).join(" ")}
