...
interface IconDotsVerticalProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconDotsVertical = ({ size, color, className, ...props }: IconDotsVerticalProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-dots-vertical", size && "size-" + size, className].filter(Boolean).join(" ")}
