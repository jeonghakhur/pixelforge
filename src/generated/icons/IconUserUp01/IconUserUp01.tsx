...
interface IconUserUp01Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconUserUp01 = ({ size, color, className, ...props }: IconUserUp01Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-user-up01", size && "size-" + size, className].filter(Boolean).join(" ")}
