...
interface IconMessageNotificationCircleProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconMessageNotificationCircle = ({ size, color, className, ...props }: IconMessageNotificationCircleProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-message-notification-circle", size && "size-" + size, className].filter(Boolean).join(" ")}
