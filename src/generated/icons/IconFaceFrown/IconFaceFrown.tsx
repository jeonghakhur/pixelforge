...
interface IconFaceFrownProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconFaceFrown = ({ size, color, className, ...props }: IconFaceFrownProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-face-frown", size && "size-" + size, className].filter(Boolean).join(" ")}
