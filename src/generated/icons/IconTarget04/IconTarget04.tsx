...
interface IconTarget04Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconTarget04 = ({ size, color, className, ...props }: IconTarget04Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-target04", size && "size-" + size, className].filter(Boolean).join(" ")}
