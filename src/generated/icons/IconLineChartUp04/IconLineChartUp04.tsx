...
interface IconLineChartUp04Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconLineChartUp04 = ({ size, color, className, ...props }: IconLineChartUp04Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-line-chart-up04", size && "size-" + size, className].filter(Boolean).join(" ")}
