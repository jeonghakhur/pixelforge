...
interface IconBarChart11Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconBarChart11 = ({ size, color, className, ...props }: IconBarChart11Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-bar-chart11", size && "size-" + size, className].filter(Boolean).join(" ")}
