...
interface IconRefreshCw01Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconRefreshCw01 = ({ size, color, className, ...props }: IconRefreshCw01Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-refresh-cw01", size && "size-" + size, className].filter(Boolean).join(" ")}
