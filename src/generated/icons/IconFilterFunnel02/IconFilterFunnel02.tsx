...
interface IconFilterFunnel02Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconFilterFunnel02 = ({ size, color, className, ...props }: IconFilterFunnel02Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-filter-funnel02", size && "size-" + size, className].filter(Boolean).join(" ")}
