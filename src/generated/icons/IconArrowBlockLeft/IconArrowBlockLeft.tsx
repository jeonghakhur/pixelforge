...
interface IconArrowBlockLeftProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconArrowBlockLeft = ({ size, color, className, ...props }: IconArrowBlockLeftProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-arrow-block-left", size && "size-" + size, className].filter(Boolean).join(" ")}
