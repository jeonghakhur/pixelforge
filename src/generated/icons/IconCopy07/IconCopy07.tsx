...
interface IconCopy07Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconCopy07 = ({ size, color, className, ...props }: IconCopy07Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-copy07", size && "size-" + size, className].filter(Boolean).join(" ")}
