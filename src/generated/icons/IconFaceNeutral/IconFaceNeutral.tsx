...
interface IconFaceNeutralProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconFaceNeutral = ({ size, color, className, ...props }: IconFaceNeutralProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-face-neutral", size && "size-" + size, className].filter(Boolean).join(" ")}
