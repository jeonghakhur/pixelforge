...
interface IconBarChart12Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconBarChart12 = ({ size, color, className, ...props }: IconBarChart12Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-bar-chart12", size && "size-" + size, className].filter(Boolean).join(" ")}
