...
interface IconPresentationChart01Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconPresentationChart01 = ({ size, color, className, ...props }: IconPresentationChart01Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-presentation-chart01", size && "size-" + size, className].filter(Boolean).join(" ")}
