...
interface IconArrowCircleBrokenLeftProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconArrowCircleBrokenLeft = ({ size, color, className, ...props }: IconArrowCircleBrokenLeftProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-arrow-circle-broken-left", size && "size-" + size, className].filter(Boolean).join(" ")}
