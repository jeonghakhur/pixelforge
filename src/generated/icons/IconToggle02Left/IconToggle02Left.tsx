...
interface IconToggle02LeftProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconToggle02Left = ({ size, color, className, ...props }: IconToggle02LeftProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-toggle02-left", size && "size-" + size, className].filter(Boolean).join(" ")}
