...
interface IconEyeProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconEye = ({ size, color, className, ...props }: IconEyeProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-eye", size && "size-" + size, className].filter(Boolean).join(" ")}
