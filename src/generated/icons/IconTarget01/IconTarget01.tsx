...
interface IconTarget01Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconTarget01 = ({ size, color, className, ...props }: IconTarget01Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-target01", size && "size-" + size, className].filter(Boolean).join(" ")}
