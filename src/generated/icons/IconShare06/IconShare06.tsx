...
interface IconShare06Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconShare06 = ({ size, color, className, ...props }: IconShare06Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-share06", size && "size-" + size, className].filter(Boolean).join(" ")}
