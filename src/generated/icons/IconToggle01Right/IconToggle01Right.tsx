...
interface IconToggle01RightProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconToggle01Right = ({ size, color, className, ...props }: IconToggle01RightProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-toggle01-right", size && "size-" + size, className].filter(Boolean).join(" ")}
