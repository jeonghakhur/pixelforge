...
interface IconPieChart04Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconPieChart04 = ({ size, color, className, ...props }: IconPieChart04Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-pie-chart04", size && "size-" + size, className].filter(Boolean).join(" ")}
