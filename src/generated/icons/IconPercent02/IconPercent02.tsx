...
interface IconPercent02Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconPercent02 = ({ size, color, className, ...props }: IconPercent02Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-percent02", size && "size-" + size, className].filter(Boolean).join(" ")}
