...
interface IconInfoHexagonProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconInfoHexagon = ({ size, color, className, ...props }: IconInfoHexagonProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-info-hexagon", size && "size-" + size, className].filter(Boolean).join(" ")}
