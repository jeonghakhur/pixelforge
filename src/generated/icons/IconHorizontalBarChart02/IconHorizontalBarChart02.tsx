...
interface IconHorizontalBarChart02Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconHorizontalBarChart02 = ({ size, color, className, ...props }: IconHorizontalBarChart02Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-horizontal-bar-chart02", size && "size-" + size, className].filter(Boolean).join(" ")}
