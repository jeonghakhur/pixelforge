...
interface IconExpand03Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconExpand03 = ({ size, color, className, ...props }: IconExpand03Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-expand03", size && "size-" + size, className].filter(Boolean).join(" ")}
