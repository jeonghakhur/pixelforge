...
interface IconBuilding06Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconBuilding06 = ({ size, color, className, ...props }: IconBuilding06Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-building06", size && "size-" + size, className].filter(Boolean).join(" ")}
