...
interface IconRefreshCw05Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconRefreshCw05 = ({ size, color, className, ...props }: IconRefreshCw05Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-refresh-cw05", size && "size-" + size, className].filter(Boolean).join(" ")}
