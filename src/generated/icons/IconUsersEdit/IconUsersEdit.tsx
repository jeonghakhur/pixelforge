...
interface IconUsersEditProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconUsersEdit = ({ size, color, className, ...props }: IconUsersEditProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-users-edit", size && "size-" + size, className].filter(Boolean).join(" ")}
