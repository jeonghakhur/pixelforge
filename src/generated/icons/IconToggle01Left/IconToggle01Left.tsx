...
interface IconToggle01LeftProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconToggle01Left = ({ size, color, className, ...props }: IconToggle01LeftProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-toggle01-left", size && "size-" + size, className].filter(Boolean).join(" ")}
