...
interface IconMessagePlusCircleProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconMessagePlusCircle = ({ size, color, className, ...props }: IconMessagePlusCircleProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-message-plus-circle", size && "size-" + size, className].filter(Boolean).join(" ")}
