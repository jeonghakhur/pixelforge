...
interface IconLineChartDown01Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconLineChartDown01 = ({ size, color, className, ...props }: IconLineChartDown01Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-line-chart-down01", size && "size-" + size, className].filter(Boolean).join(" ")}
