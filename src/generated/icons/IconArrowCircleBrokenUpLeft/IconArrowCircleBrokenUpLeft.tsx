...
interface IconArrowCircleBrokenUpLeftProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconArrowCircleBrokenUpLeft = ({ size, color, className, ...props }: IconArrowCircleBrokenUpLeftProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-arrow-circle-broken-up-left", size && "size-" + size, className].filter(Boolean).join(" ")}
