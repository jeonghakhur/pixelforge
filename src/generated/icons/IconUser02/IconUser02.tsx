...
interface IconUser02Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconUser02 = ({ size, color, className, ...props }: IconUser02Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-user02", size && "size-" + size, className].filter(Boolean).join(" ")}
