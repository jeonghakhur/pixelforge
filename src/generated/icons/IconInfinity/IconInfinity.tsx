...
interface IconInfinityProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconInfinity = ({ size, color, className, ...props }: IconInfinityProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-infinity", size && "size-" + size, className].filter(Boolean).join(" ")}
