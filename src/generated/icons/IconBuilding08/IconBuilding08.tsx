...
interface IconBuilding08Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconBuilding08 = ({ size, color, className, ...props }: IconBuilding08Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-building08", size && "size-" + size, className].filter(Boolean).join(" ")}
