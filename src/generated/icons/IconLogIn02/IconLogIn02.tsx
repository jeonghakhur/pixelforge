...
interface IconLogIn02Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconLogIn02 = ({ size, color, className, ...props }: IconLogIn02Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-log-in02", size && "size-" + size, className].filter(Boolean).join(" ")}
