...
interface IconSearchLgProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconSearchLg = ({ size, color, className, ...props }: IconSearchLgProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-search-lg", size && "size-" + size, className].filter(Boolean).join(" ")}
