...
interface IconShare05Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconShare05 = ({ size, color, className, ...props }: IconShare05Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-share05", size && "size-" + size, className].filter(Boolean).join(" ")}
