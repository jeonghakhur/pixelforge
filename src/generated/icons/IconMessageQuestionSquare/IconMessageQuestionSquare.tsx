...
interface IconMessageQuestionSquareProps extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconMessageQuestionSquare = ({ size, color, className, ...props }: IconMessageQuestionSquareProps) => (
  <svg
    width={24}
    height={24}
    className={["icon-message-question-square", size && "size-" + size, className].filter(Boolean).join(" ")}
