...
interface IconRefreshCcw02Props extends Omit<SVGProps<SVGSVGElement>, "color"> {
  size?: "default";
  color?: string; // CSS color 값 — style.color 로 적용됨 (fill="currentColor" 상속)
}

export const IconRefreshCcw02 = ({ size, color, className, ...props }: IconRefreshCcw02Props) => (
  <svg
    width={24}
    height={24}
    className={["icon-refresh-ccw02", size && "size-" + size, className].filter(Boolean).join(" ")}
